...
namespace CleanArchitecture.Presentation.Common.Errors;

internal sealed class CleanArchitectureProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;

    public CleanArchitectureProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
